        ...
        <table class="table-fixed">
            <thead>
              <tr>
                ...
                <th class="w-1/4 px-5 py-2">Jailor Username</th>
                <th class="w-1/4 px-5 py-2">Jailor Password</th>
        ...
        <?php
            ...
            while($row=mysqli_fetch_assoc($result)){?>
              ...
              <tr>
                ...
                <td class="border px-4 py-2"><?php echo$row['Jailor_uname']."<br>";?></td>
                <td class="border px-4 py-2"><?php echo$row['Jailor_pwd']."<br>";?></td>
              </tr>
