<?php
    ...
    if(isset($_SESSION['userUidOfficer'])){
      ...
      <div class="flex-grow pl-6">
        <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Update Prisoner Budget</h2>
        <p class="leading-relaxed text-base">Update Prisoner Budget according to their Behaviour</p>
        <a class="mt-3 text-indigo-500 inline-flex items-center" href="./budget.php">Update Prisoner Budget
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>
    ...
    <div class="p-4 md:w-1/3 md:mb-0 mb-6 flex">
      ...
      <div class="flex-grow pl-6">
        <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Approve Visit Requests</h2>
        <p class="leading-relaxed text-base">Approve the Visit Requests</p>
        <a class="mt-3 text-indigo-500 inline-flex items-center" href="./visit_approval.php">Approve Visit Requests
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>
    ...
    <div class="p-4 md:w-1/3 md:mb-0 mb-6 flex">
      ...
      <div class="flex-grow pl-6">
        <h2 class="text-gray-900 text-lg title-font font-medium mb-2">View Visit Requests</h2>
        <p class="leading-relaxed text-base">View all the Visit Requests</p>
        <a class="mt-3 text-indigo-500 inline-flex items-center" href="./visitor_request_view.php">View Visit Requests
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>
      ...
      <div class="flex-grow pl-6">
        <h2 class="text-gray-900 text-lg title-font font-medium mb-2">Update Prisoner Behavior</h2>
        <p class="leading-relaxed text-base">Update Behavior of Prisoners</p>
        <a class="mt-3 text-indigo-500 inline-flex items-center" href="./behavior.php">Update Prisoner Behavior
          <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
            <path d="M5 12h14M12 5l7 7-7 7"></path>
          </svg>
        </a>
...
<footer class="text-gray-700 body-font" style=" left: 0; bottom: 0;width: 100%; text-align: center;">
    <div class="bg-gray-200">
      ...
      <a
        ...
        © 2023 — Ananya , Sanchit, Kartikeya, Ashmit, Karthik, Sahil, Ann Marry
        </p>
        <span
